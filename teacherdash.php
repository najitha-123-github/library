...
<nav class="navbar">
    <div class="navbar">
        <a href="index.html" class="navbar-title">Online Library Management System</a>
        <div class="link">
            <a href="teacher_view_booking.php">Booking</a>
...
<div class="book-grid">
    <?php foreach ($books as $book): ?>
        <div class="book-item">
            ...
            <button><a style="color:white;text-decoration:none;" href="teacher_book_details.php?book_id=<?php echo urlencode($book['book_id']); ?>" class="button">View Details</a>
            </button>
        </div>
    <?php endforeach; ?>
</div>
